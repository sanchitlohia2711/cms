...
CREATE TABLE IF NOT EXISTS `cms`.`product` (
  ...
  `merchant_id` VARCHAR(45) NULL,
  `input_fields` JSON NULL,
  `how_to_redeem` JSON NULL,
...
CREATE INDEX `fk_event_physical_entity1_idx` ON `cms`.`event` (`entity_id` ASC) ;

CREATE INDEX `fk_event_physical_entity1` ON `cms`.`event` (`entity_id` ASC) ;
...
-- -----------------------------------------------------
-- Table `cms`.`product_resources`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cms`.`product_resources` ;

CREATE TABLE IF NOT EXISTS `cms`.`product_resources` (
